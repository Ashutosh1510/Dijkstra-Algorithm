...
def priority_queue(queue):  # Priority Queue, result of this are the least cost nodes 
    val = 0
...
def go_up(point, dim, tol, points_updated):
    point_x = point[0]
    point_y = point[1]
    cost = 1
...
def go_down(point, dim, tol, points_updated):
    point_x = point[0]
    point_y = point[1]
    cost = 1
...
def go_left(point, dim, tol, points_updated):
    point_x = point[0]
    point_y = point[1]
    cost = 1
...
def go_right(point, dim, tol, points_updated):
    point_x = point[0]
    point_y = point[1]
    cost = 1
...
def go_up_right(point, dim, tol, points_updated):
    point_x = point[0]
    point_y = point[1]
    cost = np.sqrt(2)
...
def go_up_left(point, dim, tol, points_updated):
    point_x = point[0]
    point_y = point[1]
    cost = np.sqrt(2)
...
def go_down_right(point, dim, tol, points_updated):
    point_x = point[0]
    point_y = point[1]
    cost = np.sqrt(2)
...
def go_down_left(point, dim, tol, points_updated):
    point_x = point[0]
    point_y = point[1]
    cost = np.sqrt(2)
...
def fetch_node(action, current_point, dim, tol, points_updated):
    if action == 'up':
        return go_up(current_point, dim, tol, points_updated)
    if action == 'down':
        return go_down(current_point, dim, tol, points_updated)
    if action == 'left':
        return go_left(current_point, dim, tol, points_updated)
    if action == 'right':
        return go_right(current_point, dim, tol, points_updated)
    if action == 'up_right':
        return go_up_right(current_point, dim, tol, points_updated)
    if action == 'up_left':
        return go_up_left(current_point, dim, tol, points_updated)
    if action == 'down_right':
        return go_down_right(current_point, dim, tol, points_updated)
    if action == 'down_left':
        return go_down_left(current_point, dim, tol, points_updated)
...
def Djikstra(image, point_robot, resolution):
    ...
    while queue:
        current_node = priority_queue(queue)
